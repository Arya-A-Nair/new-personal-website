...
const LeetCodeStats: React.FC = () => {
  ...
  const fetchLeetCodeData = async (): Promise<LeetCodeData> => {
    try {
      ...
      try {
        const userResponse = await fetch(`${baseApiUrl}/${LEETCODE_USERNAME}`, {
          method: "GET",
      ...
      <div className={styles.headerSection}>
        <div className={styles.profileInfo}>
          ...
          <div className={styles.userDetails}>
            <h3>{leetcodeData.user.name || leetcodeData.user.username}</h3>
            <div className={styles.username}>@{leetcodeData.user.username}</div>
            <div className={styles.ranking}>
              Global Ranking: #{leetcodeData.user.ranking.toLocaleString()}
            </div>
          </div>
        </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.contestSummary}>
              <div className={styles.summaryCard}>
                ...
                <div className={styles.summaryLabel}>Current Rating</div>
              </div>
              <div className={styles.summaryCard}>
                <div className={styles.summaryValue}>
                  {Math.round(leetcodeData.contest.bestRating)}
                </div>
                <div className={styles.summaryLabel}>Best Rating</div>
              </div>
              <div className={styles.summaryCard}>
                <div className={styles.summaryValue}>
                  #{leetcodeData.contest.bestRanking}
                </div>
                <div className={styles.summaryLabel}>Best Rank</div>
              </div>
              <div className={styles.summaryCard}>
                <div className={styles.summaryValue}>
                  {leetcodeData.contest.contests.length}
                </div>
                <div className={styles.summaryLabel}>Total Contests</div>
              </div>
            </div>
            ...
            <div className={styles.contestList}>
              ...
              <div className={styles.contestItems}>
                {leetcodeData.contest.contests
                  ...
                  .map((contest, index) => (
                    <div key={index} className={styles.contestItem}>
                      <div className={styles.contestHeader}>
                        <div className={styles.contestTitle}>
                          {contest.contest.title}
                        </div>
                        <div className={styles.contestDate}>
                          {formatContestDate(contest.contest.startTime)}
                        </div>
                      </div>
                      ...
                      <div className={styles.contestDetails}>
                        <div className={styles.contestStat}>
                          ...
                          <span className={styles.statValue}>
                            ...
                            <span
                              ...
                              style={{
                                color: getTrendColor(contest.trendDirection),
                              }}
                            >
                        ...
                        <div className={styles.contestStat}>
                          ...
                          <span className={styles.statValue}>
                            ...
                            {contest.finishTimeInSeconds % 60}s
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className={styles.submissionsHeader}>
              <div className={styles.submissionsInfo}>
                <span className={styles.submissionsCount}>
                  Recent {leetcodeData.recentSubmissions.length} submissions
                </span>
              </div>
              <button
                className={styles.expandButton}
                  ...
                  <div key={index} className={styles.submissionItem}>
                    <div className={styles.submissionInfo}>
                      ...
                      <div className={styles.submissionMeta}>
                        <span
                          className={styles.submissionLang}
                          style={{
                            backgroundColor: getLanguageColor(submission.lang),
                          }}
                        >
                          {submission.lang}
                        </span>
