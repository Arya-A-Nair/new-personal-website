        ...
        <div className={styles.container}>
            ...
            <div className={styles.chartContainer}>
                ...
                <div className={styles.chartBars}>
                    {recentDays.map((day: Day, index: number) => {
                        const height =
                            maxRecent > 0 ? (day.total / maxRecent) * 70 : 0;
            ...
            <div className={styles.summaryContainer}>
                ...
                <p className={styles.summaryText}>
                    ...
                    <strong>{totalHours} hours</strong> of coding time. That's
                    an average of{" "}
                    <strong>{avgHoursPerDay} hours per day</strong>, with my
                    most productive day reaching{" "}
                    <strong>{maxDayHours} hours</strong>.
                </p>
            </div>
        </div>
    );
