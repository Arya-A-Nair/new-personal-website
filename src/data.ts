...
const experience: Experience[] = [
  ...
  },
  {
    ...
    workDone: [
      ...
      "Orchestrated workflows using Prefect with state management and integrated AWS ECS for autoscaling execution under high-load surges, reducing processing turnaround time by 67%; implemented LLM evaluation pipelines with Phoenix, cutting testing errors by 50%",
    ],
  },
  {
